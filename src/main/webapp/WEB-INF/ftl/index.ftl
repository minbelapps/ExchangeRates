...
<head>
    ...
    <link rel="stylesheet"
          href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.6.0/css/bootstrap-datepicker3.min.css"
          crossorigin="anonymous">
...
<div id="content">
    ...
    <table id="currencyTable" class="datatable container">
        ...
        <#list model["exchangeRates"].exchangeRates as rate>
            ...
            <tr id="${rate.currency}">
                <td><img src="http://www.lb.lt/img/Flags/${rate.currency}.gif" width="30" height="19"
                         style="border:1px solid #E6E6E6;"></td>
                <td>${description}</td>
                <td>${rate.currency}</td>
                <td>${rate.value1}</td>
                <td>${rate.value2}</td>
